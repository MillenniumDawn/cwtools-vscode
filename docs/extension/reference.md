...
This reference documents the extension manifest and runtime behavior. The build copies only the user guide into the VSIX.

## Commands

Source: `extension/package/package.json` `contributes.commands`.
...
Source: `extension/package/package.json` `contributes.configuration`.
