...
pub const DOC_URL: &str =
    "https://github.com/MillenniumDawn/cwtools-vscode/blob/main/docs/engine/ERROR_CODES.md";

/// Link straight to `id`'s row in the error-code reference, for a reader who
/// wants the long form of what a `CWxxx` means.
///
/// The anchor is the lowercased id; `docs/engine/ERROR_CODES.md` carries one
