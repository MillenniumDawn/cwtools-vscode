...
// Both write into the generated dist/extension package. Run via
// `tsx build/esbuild.ts` (see package.json).
//
...
const extension: BuildOptions = {
	...shared,
	entryPoints: [`${extensionHostRoot}/extension.ts`],
	outfile: `${extensionDistRoot}/bin/client/extension/extension.js`,
	platform: "node",
	format: "cjs",
	target: "node18",
...
const webview: BuildOptions = {
	...shared,
	entryPoints: [`${extensionWebviewRoot}/graph.ts`],
	outfile: `${extensionDistRoot}/bin/client/webview/graph.js`,
	platform: "browser",
	format: "iife",
